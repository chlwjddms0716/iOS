...
public enum WebtoonApi {
    static let requestUrl = "https://korea-webtoon-api.herokuapp.com/?perPage=20&service=kakao&updateDay=mon"
    static let searchUrl = "https://korea-webtoon-api.herokuapp.com/search?keyword="
