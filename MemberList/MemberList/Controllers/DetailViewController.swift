...
// Info.plist -> 모든 사진에 대해서 접근해서 사용하려면 추가해야 됨 (예전 버전에서 접근하려면)
// ㄴ Privacy - Photo Library Additions Usage Description
// ㄴ Privacy - Camera Usage Description
import PhotosUI
...
final class DetailViewController: UIViewController {
    ...
    // 서로가 서로를 가리키는 강한 순환참조가 일어나서 weak으로 설정해주어야 됨
